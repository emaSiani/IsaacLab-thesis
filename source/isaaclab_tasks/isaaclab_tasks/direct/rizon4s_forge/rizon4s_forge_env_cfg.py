...
from isaaclab_tasks.direct.rizon4s_factory.rizon4s_factory_env_cfg import OBS_DIM_CFG, STATE_DIM_CFG, CtrlCfg, Rizon4sFactoryEnvCfg, ObsRandCfg
...
@configclass
class Rizon4sForgeEnvCfg(Rizon4sFactoryEnvCfg):
    action_space: int = 7
    obs_rand: ForgeObsRandCfg = ForgeObsRandCfg()
    ctrl: ForgeCtrlCfg = ForgeCtrlCfg()
    task: Rizon4sForgeTask = Rizon4sForgeTask()
...
@configclass
class Rizon4sForgeTaskPegInsertCfg(Rizon4sForgeEnvCfg):
    task_name = "peg_insert"
    task = Rizon4sForgePegInsert()
    episode_length_s = 10.0


@configclass
class Rizon4sForgeTaskGearMeshCfg(Rizon4sForgeEnvCfg):
    task_name = "gear_mesh"
    task = Rizon4sForgeGearMesh()
    episode_length_s = 20.0


@configclass
class Rizon4sForgeTaskNutThreadCfg(Rizon4sForgeEnvCfg):
    task_name = "nut_thread"
    task = Rizon4sForgeNutThread()
