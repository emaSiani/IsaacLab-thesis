...
from . import rizon4s_factory_control, rizon4s_factory_utils
from .rizon4s_factory_env_cfg import OBS_DIM_CFG, STATE_DIM_CFG, Rizon4sFactoryEnvCfg


class Rizon4sFactoryEnv(DirectRLEnv):
    cfg: Rizon4sFactoryEnvCfg

    def __init__(self, cfg: Rizon4sFactoryEnvCfg, render_mode: str | None = None, **kwargs):
       ...
       # --- INIZIO CODICE DEBUG (v8 - Orientamento) ---
        ...
        # 1. Definiamo i prototipi
        #    Usiamo "frame_prim.usd" che è un set di assi R-G-B (X-Y-Z)
        #    Lo scaleremo per renderlo visibile (es. 5 cm)
        frame_scale = (0.05, 0.05, 0.05) 
        
        goal_prototype = sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/UIElements/frame_prim.usd",
            scale=frame_scale
        )
        
        held_prototype = sim_utils.UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/UIElements/frame_prim.usd",
            scale=frame_scale
        )
        ...
        self.debug_marker_cfg = VisualizationMarkersCfg(
            ...
            markers={
                "goal_frame": goal_prototype, # Indice 0
                "held_frame": held_prototype  # Indice 1
            }
        )
        ...
        #    Indice 0 = "goal_frame", Indice 1 = "held_frame"
    ...
    def _set_default_dynamics_parameters(self):
        ...
        rizon4s_factory_utils.set_friction(self._held_asset, self.cfg_task.held_asset_cfg.friction, self.scene.num_envs)
        rizon4s_factory_utils.set_friction(self._fixed_asset, self.cfg_task.fixed_asset_cfg.friction, self.scene.num_envs)
        rizon4s_factory_utils.set_friction(self._robot, self.cfg_task.robot_cfg.friction, self.scene.num_envs)
    ...
    def close_gripper_in_place(self):
        ...
        self.generate_ctrl_signals(
            ...
            ctrl_target_gripper_dof_pos=0.123918,
        )
    ...
    def generate_ctrl_signals(
        ...
        self.joint_torque, self.applied_wrench = rizon4s_factory_control.compute_dof_torque(
            cfg=self.cfg,
    ...
    def _reset_idx(self, env_ids):
        ...
        # Default robot pose.
        print(f'Setting envs {env_ids} to default robot pose.')
    ...
    def set_pos_inverse_kinematics(
        ...
        while ik_time < 0.25:
            ...
            pos_error, axis_angle_error = rizon4s_factory_control.get_pose_error(
            ...
            # Solve DLS problem.
            delta_dof_pos = rizon4s_factory_control.get_delta_dof_pos(
    ...
    def randomize_initial_state(self, env_ids):
        ...
        print("Starting IK for envs: ", bad_envs)
        while True:
            n_bad = bad_envs.shape[0]
            print(f' n bad envs: {n_bad}')
            ...
            if bad_envs.shape[0] == 0:
                print("IK succeeded for all envs.")
                break

            self._set_rizon_to_default_pose(joints=self.cfg.ctrl.reset_joints, env_ids=bad_envs)
        ...
        self.task_deriv_gains = rizon4s_factory_utils.get_deriv_gains(
        ...
        self.task_deriv_gains = rizon4s_factory_utils.get_deriv_gains(self.default_gains)
