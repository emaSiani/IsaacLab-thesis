...
class Rizon4sFactoryEnvCfg(DirectRLEnvCfg):
    ...
    task: Rizon4sFactoryTask = Rizon4sFactoryTask()
...
@configclass
class Rizon4sFactoryTaskPegInsertCfg(Rizon4sFactoryEnvCfg):
...
@configclass
class Rizon4sFactoryTaskGearMeshCfg(Rizon4sFactoryEnvCfg):
    task_name = "gear_mesh"
    task = GearMesh()
...
@configclass
class Rizon4sFactoryTaskNutThreadCfg(Rizon4sFactoryEnvCfg):
